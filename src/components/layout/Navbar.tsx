...
import { Search, Menu, X, ArrowUpRight, Music2 } from 'lucide-react';
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 border-l border-r border-white/10 px-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 text-vexo-muted hover:text-green-400 transition-colors"
                title="Spotify"
              >
        ...
        <div className="relative z-10 pt-6 border-t border-white/10 flex flex-col gap-5">
          ...
          <div className="flex items-center justify-between text-xs text-vexo-muted">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://spotify.com" target="_blank" rel="noopener noreferrer" className="hover:text-green-400">
                Spotify
              </a>
            </div>
          </div>
