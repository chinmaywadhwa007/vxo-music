...
import { MapPin, Phone, Mail, ArrowUp, Music2 } from 'lucide-react';
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2 flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                ...
                rel="noopener noreferrer"
                title="Spotify"
                className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-vexo-muted hover:text-green-400 hover:border-green-400/50 hover:bg-green-400/10 transition-all duration-300"
              >
